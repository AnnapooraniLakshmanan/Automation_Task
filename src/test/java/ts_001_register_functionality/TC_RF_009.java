...
public class TC_RF_009 extends Base_Class 
{
	...
	public void creatingNewAccBySelectingKeyboards(String[] testdata) throws Throwable
	{
		ip=new Index_Page(driver);
		lp=ip.clickSignInBtn();
		rp=lp.toCreateNewAccount(testdata[0]);
		rp.createAccountWithKeyboard(testdata[1],testdata[2],testdata[3],testdata[4],testdata[5],testdata[6],testdata[7]);
