...
public class TC_RF_002 extends Base_Class
{
	Index_Page ip;
	Login_Page lp;
	...
	@Test(dataProvider = "Invalid Email",dataProviderClass = DataaProviders.class)
	public void createAnAccountByProvidingValidMailid(String[] testdata02) throws Throwable
	{
		ip=new Index_Page(driver);
		lp=ip.clickSignInBtn();
		rp=lp.toCreateNewAccount(testdata02[0]);
