...
public class TC_RF_001 extends Base_Class
{
	Index_Page ip;
	Login_Page lp;
	...
	@Test(dataProvider = "Valid Email",dataProviderClass = DataaProviders.class)
	public void createAnAccountByProvidingValidMailid(String[] tesstdata) throws Throwable
	{
