...
public class TC_RF_016 extends Base_Class 
{
	Index_Page ip;
	Login_Page lp;
	...
	public void pswdLessThan5Char(String[] testdata) throws Throwable
	{
		ip=new Index_Page(driver);
		lp=ip.clickSignInBtn();
		rp=lp.toCreateNewAccount(testdata[0]);
		rp.createAccountWithMandatoryFields(testdata[2],testdata[3],testdata[4]);
