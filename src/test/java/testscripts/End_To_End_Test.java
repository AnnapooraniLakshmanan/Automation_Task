...
public class End_To_End_Test extends Base_Class
{
	Index_Page ip;
	Login_Page lp;
	...
	public void validateMyAccPage(String[] testdata) throws Throwable
	{
		...
		boolean res=map.validateAccountSuccessfulCreation(testdata[2],testdata[3]);
	    Assert.assertEquals(res,true);
	    Reporter.log("User has been created an acc successfully!!!!",true);
	}
}
